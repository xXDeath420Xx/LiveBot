...
var reminderQueue = new bullmq_1.Queue('reminders', { connection: cache_1.redisOptions });
/**
...
function scheduleReminderChecks() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, reminderQueue.add('check-reminders', {}, {
                        repeat: {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, reminderQueue.close()];
                case 2:
                    _a.sent();
                    return [2 /*return*/];
            }
