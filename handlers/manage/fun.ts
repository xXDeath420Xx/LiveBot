...
export async function handleMeme(interaction: ChatInputCommandInteraction): Promise<void> {
    ...
    try {
        ...
        logger.error("[Meme Command Error]", error as Record<string, any>);
 ...
 * @param {Interaction} interaction - Discord interaction object
 */
export async function handleCat(interaction: ChatInputCommandInteraction): Promise<void> {
    await interaction.deferReply();
    ...
    try {
        ...
        logger.error('[Cat Command Error]', error as Record<string, any>);
