...
exports.handleNowPlaying = handleNowPlaying;
...
async function handleNowPlaying(interaction) {
    ...
    const embed = new discord_js_1.EmbedBuilder()
        ...
        .addFields({ name: "Artist", value: track.author || "N/A", inline: true }, { name: "Duration", value: track.duration || "0:00", inline: true }, { name: "Requested by", value: requesterTag, inline: true }, { name: "Progress", value: progress, inline: false });
