...
/**
 * Handle suggestion downvote button clicks
 * @param {ButtonInteraction} interaction
 */
export async function handleSuggestionDownvote(interaction) {
    try {
        ...
        if (result.action === 'removed') {
            ...
            responseMessage = 'Changed your vote to downvote!';
        } else {
            responseMessage = 'Your downvote has been recorded!';
        }
        ...
        logger.error('[Suggestion Downvote Button Error]', error);
        await interaction.reply({
...
export default handleSuggestionDownvote;
