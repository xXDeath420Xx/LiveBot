...
module.exports = {
  ...
  async execute(interaction) {
    ...
    try {
      ...
      if (rows.some(r => r.platform === "tiktok" || r.platform === "youtube")) {
        ...
        try {
          ...
          for (const channelId of channelIds) {
            ...
            if (existingSubscription) {
              ...
              await db.execute(
                `INSERT INTO subscriptions (guild_id, streamer_id, custom_message, override_nickname, override_avatar_url, announcement_channel_id)
                 VALUES (?, ?, ?, ?, ?, ?)`,
