 ...
 */
class YtdlpExtractor extends discord_player_1.BaseExtractor {
    ...
    async handle(query, searchOptions) {
        ...
        try {
            ...
            const err = error;
            this.logger.error(`[YtdlpExtractor] Handle error: ${err.message}`);
            throw error;
        }
    }
    async searchYouTube(query) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const ytdlp = (0, child_process_1.spawn)(this.ytdlpPath, args);
            let stdout = '';
            let stderr = '';
    ...
    async stream(info) {
        ...
        try {
            ...
            const err = error;
            this.logger.error(`[YtdlpExtractor] Stream error: ${err.message}`);
            throw error;
        }
    }
    /**
    ...
    async cleanCache() {
        try {
            ...
            const err = error;
            this.logger.error(`[YtdlpExtractor] Cache cleanup error: ${err.message}`);
        }
    }
}
exports.YtdlpExtractor = YtdlpExtractor;
YtdlpExtractor.identifier = 'com.certifried.ytdlp';
