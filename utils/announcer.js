...
function updateAnnouncement(client, subContext, liveData, existingAnnouncement, guildSettings, channelSettings, teamSettings, targetChannelId) {
    return __awaiter(this, void 0, void 0, function () {
        var platformName, platformColor, embed, content, finalNickname, finalAvatarURL, discordUser, error_1, webhookClient, messageOptions, editedMessage, e_2, sentMessage, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 1:
                    ...
                    finalNickname = liveData.username;
                    ...
                    if (!subContext.discord_user_id) return [3 /*break*/, 6];
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                    return [4 /*yield*/, client.users.fetch(subContext.discord_user_id)];
                case 3:
                    discordUser = _a.sent();
                    if (discordUser) {
                        finalAvatarURL = discordUser.displayAvatarURL({ size: 256 });
                        logger_1.logger.info("[Announcer] Using Discord avatar for ".concat(liveData.username, " (Discord ID: ").concat(subContext.discord_user_id, ")"), {
                ...
                case 4:
                    error_1 = _a.sent();
                    logger_1.logger.warn("[Announcer] Failed to fetch Discord user avatar for ".concat(liveData.username), {
                        discordUserId: subContext.discord_user_id,
                        error: error_1,
                        category: 'announcer'
                    });
                ...
                case 7:
                    ...
                    else if (channelSettings === null || channelSettings === void 0 ? void 0 : channelSettings.override_nickname)
                ...
                case 8:
                    ...
                    if (!(existingAnnouncement === null || existingAnnouncement === void 0 ? void 0 : existingAnnouncement.message_id)) return [3 /*break*/, 13];
                    _a.label = 9;
                case 9:
                ...
                case 13: return [4 /*yield*/, webhookClient.send(messageOptions)];
                case 14:
                    sentMessage = _a.sent();
