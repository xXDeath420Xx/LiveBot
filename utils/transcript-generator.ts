import { Message, Embed, User, Collection, Attachment } from 'discord.js';

/**
 * Transcript Generator for Discord Ticket System
 *
 * Generates HTML transcripts of Discord channel messages
 * with proper formatting for embeds, attachments, and user data
 */
 ...
 */
export function generateTranscript(messages: Message[] | MessageData[]): string {
    const transcript = `
        <!DOCTYPE html>
        <html>
        <head>
 ...
 */
function formatMessage(message: Message | MessageData): string {
