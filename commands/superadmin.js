...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (subcommand === 'global-reinit') {
        ...
        const confirmButton = new ButtonBuilder().setCustomId("confirm_global_reinit").setLabel("I understand, restart the bot globally").setStyle(ButtonStyle.Danger);
        const cancelButton = new ButtonBuilder().setCustomId("cancel_global_reinit").setLabel("Cancel").setStyle(ButtonStyle.Secondary);
